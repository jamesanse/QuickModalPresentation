#
#  Be sure to run `pod spec lint QuickModalPresentation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jin"
  # s.authors            = { "jin" => "jamesanse@gmail.com" }
  # s.social_media_url   = "http://twitter.com/jin"
  ...
  s.source       = { :git => "https://github.com/jamesanse/QuickModalPresentation.git", :tag => "0.0.1" }
